import svgPaths from "./svg-740brh66g4";
...
function IconText() {
  return (
    <div className="content-stretch flex gap-[13px] items-center relative shrink-0" data-name="Icon+ Text">
      <Icon />
      <p className="css-ew64yg font-['Inter:Light',sans-serif] font-light leading-[normal] not-italic relative shrink-0 text-[16px] text-black">{`Type your response `}</p>
    </div>
  );
}
    ...
    <div className="backdrop-blur-[0px] bg-white flex-[1_0_0] min-h-px min-w-px mr-[-8px] relative rounded-[16px]" data-name="Text content">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center px-[12px] py-[16px] relative w-full">
          <p className="css-4hzbpn font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#191818] text-[16px] w-[298px]">To personalise your plan, I’ll need your age and gender.</p>
        </div>
      </div>
    </div>
  );
...
function ContentArea() {
  return (
    <div className="content-stretch flex items-center pr-[8px] relative shadow-[0px_2px_2px_0px_rgba(0,0,0,0.08)] shrink-0 w-[333px]" data-name="Content Area">
      <div className="flex items-center justify-center mr-[-8px] relative shrink-0 size-[19px]" style={{ "--transform-inner-width": "0", "--transform-inner-height": "21.59375" } as React.CSSProperties}>
          ...
          <div className="relative size-[19px]" data-name="Tip">
            <div className="absolute bottom-1/4 left-[10.54%] right-[10.54%] top-[5.26%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.9934 13.25">
                ...
                <defs>
                  <clipPath id="bgblur_0_423_142_clip_path" transform="translate(32.4 32.4)">
...
function Frame7() {
  return (
    <div className="absolute content-stretch flex items-start left-1/2 px-[12px] top-[129px] translate-x-[-50%] w-[428px]">
...
function Icon1() {
  return (
    <div className="relative shrink-0 size-[18px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
        <g clipPath="url(#clip0_423_123)" id="Icon">
...
function ExampleResponseHeader() {
  return (
    <div className="flex-[1_0_0] h-[19.5px] min-h-px min-w-px relative" data-name="Example response header">
      <p className="absolute css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[18px] left-0 not-italic text-[#0a70ff] text-[13px] top-[0.4px]">Example Response:</p>
    </div>
  );
}
...
function Description() {
  return (
    <div className="h-[13px] relative shrink-0 w-full" data-name="Description">
      <p className="absolute css-4hzbpn font-['Inter:Medium',sans-serif] font-medium leading-[18px] left-0 not-italic text-[#0a70ff] text-[12px] top-[-0.4px] w-[298px]">I’m 29 and female.</p>
    </div>
  );
}
...
function Description1() {
  return (
    <div className="h-[13px] relative shrink-0 w-full" data-name="Description">
      <p className="absolute css-4hzbpn font-['Inter:Medium',sans-serif] font-medium leading-[18px] left-0 not-italic text-[#0a70ff] text-[12px] top-[-0.4px] w-[298px]">30, male.</p>
    </div>
  );
}
...
function ExampleContent() {
  return (
    <div className="absolute content-stretch flex flex-col items-center left-1/2 px-[20px] top-[215px] translate-x-[-50%] w-[428px]" data-name="Example Content">
      <Content />
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0">
      <Button />
      <p className="css-ew64yg font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[12px] text-white">Edit Details</p>
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="absolute bg-[#c21b17] content-stretch flex h-[40px] items-center justify-between left-0 px-[16px] py-[10px] right-0 top-[58px]">
      <Frame6 />
