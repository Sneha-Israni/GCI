import svgPaths from "./svg-draar29glp";
...
function TextContent() {
  return (
    <div className="absolute backdrop-blur-[0px] backdrop-filter bg-[#ff5050] content-stretch flex items-center justify-end left-[95px] overflow-clip p-[12px] rounded-[12px] top-0" data-name="Text content">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[16px] text-white w-[272px]">Save for Kid’s Education</p>
    </div>
  );
}
...
function UserResponse() {
  return (
    <div className="absolute h-[44px] left-1/2 shadow-[0px_2px_2px_0px_rgba(0,0,0,0.08)] top-[71px] translate-x-[-50%] w-[428px]" data-name="User Response">
      <TextContent />
    </div>
  );
}
    ...
    <div className="backdrop-blur-[0px] backdrop-filter basis-0 bg-white grow min-h-px min-w-px mr-[-8px] relative rounded-[16px] shrink-0" data-name="Text content">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center px-[12px] py-[16px] relative w-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#191818] text-[16px] w-[298px]">{`Great! How much are you planning to save for your kid's education & by when?`}</p>
        </div>
      </div>
    </div>
  );
...
function Frame3() {
  return (
    <div className="absolute content-stretch flex items-start left-1/2 px-[12px] py-0 top-[147px] translate-x-[-50%] w-[428px]">
...
function Description() {
  return (
    <div className="h-[13px] relative shrink-0 w-full" data-name="Description">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[18px] left-0 not-italic text-[#0a70ff] text-[12px] top-[-0.4px] w-[298px]">I am planning to save 1 cr in 20 years</p>
    </div>
  );
}
...
function Content() {
  return (
    <div className="bg-[#f7faff] content-stretch flex flex-col items-start p-[16px] relative rounded-[16px] shrink-0 w-[372px]" data-name="Content">
...
function ExampleContent() {
  return (
    <div className="absolute content-stretch flex flex-col items-center left-1/2 px-[20px] py-0 top-[257px] translate-x-[-50%] w-[428px]" data-name="Example Content">
      <Content />
    </div>
  );
}
...
export default function NewFlow() {
  return (
    <div className="bg-gradient-to-b from-[#ffe9e7] relative size-full to-[#fffefe]" data-name="New flow/3">
      <Frame4 />
      <StatusBarIPhone />
      <UserResponse />
      <Frame3 />
