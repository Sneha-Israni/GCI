import svgPaths from "./svg-60ras9rmgt";
...
function Container7() {
  return <div className="absolute bg-[rgba(0,0,0,0.4)] h-[925px] left-0 top-px w-[428px]" data-name="Container" />;
}

function BottomSheet() {
  return <div className="bg-[#d1d5dc] h-[5px] rounded-[1.67772e+07px] shrink-0 w-[36px]" data-name="BottomSheet" />;
}

function BottomSheet1() {
  return (
    <div className="h-[37px] relative shrink-0 w-full" data-name="BottomSheet">
      ...
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col items-center justify-between pb-px pt-0 px-[20px] relative size-full">
          <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] not-italic relative shrink-0 text-[#101828] text-[16px] text-center text-nowrap tracking-[-0.3125px]">Edit Onboarding Details</p>
        </div>
      </div>
    </div>
  );
...
function FormField() {
  return (
    <div className="content-stretch flex h-[17px] items-start relative shrink-0 w-[348px]" data-name="FormField2">
      <p className="basis-0 font-['Inter:Regular',sans-serif] font-normal grow leading-[normal] min-h-px min-w-px not-italic relative shrink-0 text-[#263238] text-[14px]">Age</p>
    </div>
  );
}
...
function TextInput() {
  return (
    <div className="absolute content-stretch flex h-[19.5px] items-center left-[12px] overflow-clip top-[14px] w-[324px]" data-name="Text Input">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[16px] text-black text-nowrap">Ramesh Kumar Sharma</p>
    </div>
  );
}
...
function Container8() {
  return (
    <div className="h-[47px] overflow-clip relative rounded-[12px] shrink-0 w-[388px]" data-name="Container">
      <TextInput />
    </div>
  );
}
...
function Container9() {
  return (
    <div className="absolute h-[48px] left-0 rounded-[12px] top-[-0.5px] w-[388px]" data-name="Container">
...
function FormField1() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[10px] items-start relative rounded-[12px] shrink-0 w-full" data-name="FormField2">
      <Container8 />
      <Container9 />
    </div>
  );
...
function FormField2() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-0 top-0 w-[348px]" data-name="FormField2">
      <p className="basis-0 font-['Inter:Regular',sans-serif] font-normal grow leading-[normal] min-h-px min-w-px not-italic relative shrink-0 text-[#263238] text-[14px]">Gender</p>
    </div>
  );
}
...
function TextInput1() {
  return (
    <div className="absolute content-stretch flex h-[19.5px] items-center left-[12px] overflow-clip top-[14px] w-[324px]" data-name="Text Input">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[16px] text-black text-nowrap">Male</p>
    </div>
  );
}
...
function Container11() {
  return (
    <div className="absolute h-[47.5px] left-0 overflow-clip rounded-[12px] top-0 w-[348px]" data-name="Container">
      <TextInput1 />
    </div>
  );
}
...
function Container12() {
  return <div className="absolute border border-[#e5e7eb] border-solid h-[47px] left-0 rounded-[12px] top-0 w-[388px]" data-name="Container" />;
}

function FormField3() {
  return (
    <div className="absolute bg-white h-[47px] left-0 rounded-[12px] top-[25px] w-[388px]" data-name="FormField2">
      <Container11 />
      <Container12 />
    </div>
  );
...
function Container13() {
  return (
    <div className="h-[72.5px] relative shrink-0 w-full" data-name="Container">
      <FormField2 />
      <FormField3 />
    </div>
  );
...
function FormField4() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-0 top-0 w-[348px]" data-name="FormField2">
      <p className="basis-0 font-['Inter:Regular',sans-serif] font-normal grow leading-[normal] min-h-px min-w-px not-italic relative shrink-0 text-[#263238] text-[14px]">Goal</p>
    </div>
  );
}
...
function TextInput2() {
  return (
    <div className="absolute content-stretch flex h-[19.5px] items-center left-[12px] overflow-clip top-[14px] w-[324px]" data-name="Text Input">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[16px] text-black text-nowrap">Kids Education</p>
    </div>
  );
}
...
function Container16() {
  return (
    <div className="content-stretch flex flex-col items-start relative size-[20px]" data-name="Container">
      <Icon2 />
    </div>
  );
}
...
function FormField5() {
  return (
    <div className="absolute bg-white h-[48px] left-0 rounded-[12px] top-[24.5px] w-[388px]" data-name="FormField2">
      <Container14 />
      <Container15 />
      <div className="absolute flex items-center justify-center right-[10px] size-[20px] top-1/2 translate-y-[-50%]" style={{ "--transform-inner-width": "0", "--transform-inner-height": "0" } as React.CSSProperties}>
...
function PersonalDetailsForm() {
  return (
    <div className="relative shrink-0 w-full" data-name="PersonalDetailsForm">
      <div className="overflow-clip rounded-[inherit] size-full">
...
function Button1() {
  return (
    <div className="basis-0 bg-white grow h-[50px] min-h-px min-w-px relative rounded-[12px] shrink-0" data-name="Button">
      <div aria-hidden="true" className="absolute border border-[#d1d5dc] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[24px] left-[84.71px] not-italic text-[#263238] text-[16px] text-center text-nowrap top-[12px] translate-x-[-50%]">Cancel</p>
      </div>
    </div>
  );
}
...
function Button2() {
  return (
    <div className="basis-0 bg-gradient-to-b from-[#c21b17] grow h-[50px] min-h-px min-w-px relative rounded-[12px] shrink-0 to-[#a11612]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[24px] left-[83.63px] not-italic text-[16px] text-center text-nowrap text-white top-[12px] translate-x-[-50%]">Save Changes</p>
      </div>
    </div>
  );
}
...
function PersonalDetailsForm1() {
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="PersonalDetailsForm">
...
function BottomSheet2() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start overflow-clip relative shrink-0 w-full" data-name="BottomSheet">
      <PersonalDetailsForm />
...
function Container20() {
  return (
    <div className="absolute bg-white bottom-0 content-stretch flex flex-col gap-[10px] items-center left-1/2 overflow-clip px-0 py-[10px] rounded-tl-[20px] rounded-tr-[20px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] translate-x-[-50%] w-[428px]" data-name="Container">
      <BottomSheet />
      <BottomSheet1 />
      <BottomSheet2 />
    </div>
