import svgPaths from "./svg-srk443xpht";
...
function Frame7() {
  return (
    <div className="absolute content-stretch flex items-start left-1/2 px-[12px] py-0 top-[129px] translate-x-[-50%] w-[428px]">
...
function ExampleContent() {
  return (
    <div className="absolute content-stretch flex flex-col items-center left-1/2 px-[20px] py-0 top-[215px] translate-x-[-50%] w-[428px]" data-name="Example Content">
      <Content />
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0">
      <Button />
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[12px] text-white w-[190px]">Edit Details</p>
    </div>
  );
}
